...
Spec of record: `C:\dev\working_docs\projects\table-viewer\table-viewer-spec.md` (approved 2026-09-22), with the project brief and the build decisions log beside it.
